...
const createNewBlock = (data:string):Block=>{
  ...
  const nextHash:string = Block.calculateBlockHash(newIdx,previousBlock.hash,nextTimeStamp,data);
  const newBlock:Block = new Block(newIdx,nextHash,previousBlock.hash,data,nextTimeStamp);
  addBlock(newBlock);
  return newBlock;
}
